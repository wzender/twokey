...
The app allows users to record their voice, sends the audio to Google Gemini 1.5 Flash for analysis, and returns a pronunciation score with specific feedback on Levantine phonemes (e.g., Qaf, Haa, 'Ayn).
...
* **AI:** Google Gemini API (`google-generativeai`) using the `gemini-1.5-flash` model.
